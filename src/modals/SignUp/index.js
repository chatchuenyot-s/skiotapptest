                  ...
                  <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end sm:p-[15px] md:p-[54px] p-[79px] rounded-radius15">
                    ...
                    <Column className="flex flex-col items-center md:ml-[55px] ml-[80px] sm:mx-[0] sm:pb-[2px] md:pb-[3px] pb-[5px] sm:px-[0] sm:w-[100%] w-[42%]">
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-center sm:mt-[14px] md:mt-[19px] mt-[28px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[69%]">
                        ...
                        <Text
                          className="font-normal ml-[10px] sm:ml-[5px] md:ml-[6px] not-italic text-gray_700 w-[auto]"
                          variant="body5"
                        >
                      ...
                      <Column className="flex flex-col justify-start sm:mt-[13px] md:mt-[17px] mt-[25px] w-[100%]">
                        ...
                        <CheckBox
                          className="font-medium sm:mt-[12px] md:mt-[15px] mt-[23px] text-[16px] text-gray_700"
                          inputClassName="mr-[5px]"
                          name="Iagreedtothe"
                          label="I agreed to the Terms & Conditions"
                        ></CheckBox>
                        <Button
                          className="common-pointer cursor-pointer font-medium sm:mt-[14px] md:mt-[19px] mt-[28px] text-[16px] text-center text-white_A700 w-[100%]"
                          onClick={handleNavigate13}
                          size="md"
                        >
                          Sign Up
                        </Button>
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[48px] ml-[70px] sm:mt-[17px] md:mt-[22px] mt-[33px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[63%]">
                          <Text
                          ...
                          <Text
                            className="common-pointer font-medium mb-[1px] ml-[4px] text-red_300 w-[auto]"
                            variant="body5"
